...
<body>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<form action="{{route('.create-loaido')}}" method="POST" enctype="multipart/form-data">
				@csrf
				<div class="col-sm-12 col-xl-6">
					<div class="bg-light rounded h-100 p-4">
						<h6 class="mb-4">Thêm Loại Đồ</h6>
						<div class="input-group mb-3">
							<input type="text" class="form-control" placeholder="Tên Loại Đồ" name="loaido" aria-describedby="basic-addon1">
						</div>
						@if(session('Error'))
