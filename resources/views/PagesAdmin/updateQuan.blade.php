...
<body>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<form method="Post" action="{{route('.update-quan',['id'=>$Quan->id])}}">
				@csrf
				...
				<div class="col-sm-12 col-xl-6">
					<div class="bg-light rounded h-100 p-4">
						...
						<div class="input-group mb-3">
							<input type="text" class="form-control" placeholder="{{$Quan->tenquan}}" name="tenquan" aria-describedby="basic-addon1">
						</div>
						@if(session('Error'))
