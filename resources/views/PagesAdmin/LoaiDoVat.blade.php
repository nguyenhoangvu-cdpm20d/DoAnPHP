...
<body>
	...
	<section id="content">
		...
		<main>
			...
			<a href="{{route('.add-loaido')}}"><button type="button" class="btn btn-primary" data-toggle="button" aria-pressed="false" autocomplete="off">
					Thêm Loại Đồ Vật
				</button></a>
				...
				<div class="order">
					...
					<table>
						<thead>
							<tr>
								<th>ID</th>
								<th>Tên Loại Đồ Vật</th>
								<th>Chức Năng</th>
							</tr>
						</thead>

						<tbody>
							@foreach($loaidovat as $List)
							<tr>
								<td>{{$List->id}}</td>
								<td>{{$List->loaido}}</td>
								<td>
