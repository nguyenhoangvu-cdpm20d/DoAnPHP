...
<body>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<form method="Post" action="{{route('.update-loaido',['id'=>$LoaiDo->id])}}">
				@csrf
                
				<div class="col-sm-12 col-xl-6">
					<div class="bg-light rounded h-100 p-4">
						<h6 class="mb-4">Chỉnh sửa Loại Đồ Vật</h6>
						<div class="input-group mb-3">
							<input type="text" class="form-control" placeholder="{{$LoaiDo->loaido}}" name="loaido" aria-describedby="basic-addon1">
						</div>
						@if(session('Error'))
