            ...
            <div class="table-data">
                <div class="order">
                    ...
                    <table>
                        ...
                        <tbody>
                            @foreach($baocao as $List)
                            <tr>
                                <td>{{$List->id}}</td>
                                <td>{{$List->Username}}</td>
                                <td>{{$List->noidung}}</td>
                                <td> <a href="/ChiTietBaiViet/{{$List->idBaiViet}}" class="btn btn-outline-success">Xem chi
                                        tiết</a></td>
                                <td>{{$List->created_at->format('d/m/Y')}}</td>
                                <td> <a href="/delete_baocao/{{$List->id}}" class="btn btn-outline-danger">Xoá
