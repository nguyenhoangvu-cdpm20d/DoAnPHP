...
<body>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<form method="Post" action="{{route('.update-phuong',['id'=>$Phuong->id])}}">
				@csrf
                
				<div class="col-sm-12 col-xl-6">
					<div class="bg-light rounded h-100 p-4">
						<h6 class="mb-4">Chỉnh sửa Quận</h6>
						<div class="input-group mb-3">
							<input type="text" class="form-control" placeholder="{{$Phuong->tenphuong}}" name="tenphuong" aria-describedby="basic-addon1">
						</div>
						@if(session('Error'))
