        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    <img class="rounded-circle mt-5" width="150px" height="150px" src="{{asset('anh/10.jpg')}}" class="imageUpload">
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6"><label class="labels" for="phone">Phone</label><input type="text" class="form-control" value=" {{Auth::user()->phone}}" placeholder="Số điện thoại"></div>
