        ...
        <div class="col-md-8">
                ...
                <div class="bg-white p-2">
                    <div class="d-flex flex-row user-info"><img class="rounded-circle" src="image/123.jpg" width="40">
                        <div class="d-flex flex-column justify-content-start ml-2"><span
                                class="d-block font-weight-bold name">{{$baiviet->TenTK}}</span>
                        </div>
                    </div>
                    <!-- loại bài viết  -->
                    ...
                    <div>
                        ...
                        <img style="margin-top: -20px;margin-left: 10px;" width="250px" height="250px"
                            class="img-responsive thumbnail" src="{{asset('anh/')}}/{{$baiviet->image}}" alt="Image">
                    </div>
                </div>
            </div>
            <div>
            ...
            @foreach($ListComment as $Comment)
                ...
                <div>
                    <div class="d-flex flex-row align-items-start">
                        ...
                        <div>
                            <p
                                style="margin-left: 5px;border: 10px;border: solid grey;/* background-color: grey; */border-radius: 7px;display: inline-block;padding: 3px;">
                                {{$Comment->noidung}}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white" style="text-align: center;">
                <div class="d-flex flex-row fs-12">
                    <div class="like p-2 cursor"><i class="fa fa-commenting-o"></i><span class="ml-1">Bình Luận</span>
                    </div>
                </div>
            </div border="1">
            <div>
            ...
            <form method="POST">
                @csrf
                <div>
                    <div class="d-flex flex-row align-items-start"><img class="rounded-circle " src="image/123.jpg"
                            width="40">
                        <textarea class="form-control ml-1 shadow-none textarea" style="border:solid grey"
