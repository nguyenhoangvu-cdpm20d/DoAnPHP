    ...
    <div class="s-content content">
        <main class="row content__page">
            ...
            <section class="column large-full entry format-standard">
                ...
                <form name="contactForm" id="contactForm" method="post" action="{{route('Add_Post')}}"
                    ...
                    <fieldset>
                        ...
                        <div class="form-field">
                            <input name="Title" id="cName" class="full-width" placeholder=" Tiêu đề" value=""
                                type="text" required>
                        </div>
                        <br>
                        <div>
                            <label class="text-demo" for="birthday">Thời gian mất hoặc nhặt được:</label>
                        ...
                        <div>
                            <label class="text-demo" for="quan_id">Quận/Huyện/TP</label>
                            <select name="quan_id" id="cars">
                        ...
                        <br>
                        <div>
                            <label class="text-demo" for="phuong_id">Phường/Xã/Thị Trấn</label>
                            <select name="phuong_id" id="cars">
                        ...
                        <div class="message form-field">
                            <textarea name="noidung" id="cMessage" class="full-width" placeholder="Nội dung"
                                required></textarea>
                        </div>
                        <br>
                        <div>
                            <main>
                                <div class="container imageUploadContainer">
                                    ...
                                    <div class="imageUpload">
                                        <input name="anh" type="file" id="imageUploadInput" onchange="chooseFile(this)"
                        ...
                        <br>
                        <input name="submit" id="submit" class="snip1582"
                            value="Đăng tin" type="submit">
